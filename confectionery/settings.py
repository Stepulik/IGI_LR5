...
# Загружаем переменные из .env файла (нужен для локальной разработки)
...
# База данных: на Render будет использоваться DATABASE_URL, локально — SQLite
DATABASES = {
...
LOGGING = {
    ...
    'handlers': {
        ...
        'file': {'class': 'logging.FileHandler',
                 'filename': BASE_DIR / 'logs' / 'confectionery.log',
                 'formatter': 'verbose'},
    },
